...
<br><br><br><br>
    <div class="container">
        ...
        <p class="text-center">Find out your nearest Tourist Attractions!</p>
                ...
                <div class="col-md-<?php echo $bootstrapColWidth; ?>" style="margin-bottom: 50px">
                    <div class="card h-100 shadow rounded-3">
                        <div class="card-img-top">
                            <img src="/images/{{ $prk->park_img }}" class="card-img-top img-fluid" alt="guide_photo"
                                style="width:35px, height:35px;">
                        </div>
                        <div class="card-body">
                            <h5 class="card-title"><strong>{{ $prk->park_name }}</strong></h5>
                            <p>
                        ...
                        <div class="card-footer">
                            <a type="button" class="btn btn-success btn-block text-center"
                                href="{{ route('park.show', $prk->id) }}" target="_blank"
                               >Details</a>
                        </div>
                    </div>
                    <br>
