...
<body>
    ...
    <header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
        <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3" href="{{ url('/admin') }}">Kelana Admin</a>
    ...
    <div class="container-fluid">
        <div class="row">
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="position-sticky pt-3">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ url('verifyGuide') }}">
                                <span data-feather="users"></span>
                                Verifikasi Tourguide
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ url('listFeedback') }}">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                @yield('content')
                <canvas class="my-4 w-100" id="myChart" width="900" height=""></canvas>
            </main>
        </div>
    </div>
    ...
    <script src="/docs/5.0/dist/js/bootstrap.bundle.min.js" integrity="sha384-gtEjrD/SeCtmISkJkNUaaKMoLD0//ElJ19smozuHV6z3Iehds+3Ulb9Bn9Plx0x4" crossorigin="anonymous">
    </script>
