        ...
        <div class="col-sm">
            <div class="card shadow mb-5 bg-white rounded" style="width: 18rem;">
                ...
                <div class="card-footer">
                    <button type="submit" name="add_cart" class="btn btn-primary text-center btn-block">Add to Cart</button>
                </div>
                </form>
            </div>
        </div>
        <div class="col-sm">
            <div class="card shadow mb-5 bg-white rounded" style="width: 18rem;">
                ...
                <div class="card-body text-center">
                    ...
                    <form method="post" action="process_cart.php?action=add">
                        <input class="form-control" type="hidden" name="user_id" value="<?php $user_id ?>">
                        <input class="form-control" type="hidden" name="nama_barang" placeholder="xx" value="xx" readonly>
                        <input class="form-control" type="hidden" name="harga" placeholder="" value="" readonly>
                </div>
                <div class="card-footer">
                    <button type="submit" name="add_cart" class="btn btn-primary text-center btn-block">Add to Cart</button>
        ...
        <div class="col-sm">
            <div class="card shadow mb-5 bg-white rounded" style="width: 18rem;">
                ...
                <div class="card-body text-center">
                    ...
                    <form method="post" action="process_cart.php?action=add">
                        <input class="form-control" type="hidden" name="user_id" value="<?php $user_id ?>">
                        <input class="form-control" type="hidden" name="nama_barang" placeholder="pp" value="pp" readonly>
                        <input class="form-control" type="hidden" name="harga" placeholder="" value="" readonly>
                </div>
                <div class="card-footer">
                    <button type="submit" name="add_cart" class="btn btn-primary text-center btn-block">Add to Cart</button>
